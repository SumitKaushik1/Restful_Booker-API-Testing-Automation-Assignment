...
import static org.restfullbooker.task_6_negative._1_getallbooking.RestfullBookerRequestGetAllBookingURL.restfullBookerRequestGetAllBookingURL;


public class RestFullBookerGetAllBookingTestCases {

    public static String bookingidToDelete1;
    @Test
    ...
    void resfullBookerGetAllBookingContainsBookingIdAsText () throws JsonProcessingException {
        ...
        bookingidToDelete1=jsonPath.getString("[0].bookingid");

        //static variable withing a class can be accessed
        System.out.println(bookingidToDelete1);//$.[0].bookingid ->jasonpath
